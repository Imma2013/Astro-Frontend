  ...
  return (
    <div
      className={classNames(
        ...
        'bg-Astro-elements-background-depth-2 dark:bg-Astro-elements-background-depth-3 rounded-lg',
        styles.container,
        className,
      )}
    >
      ...
      <div
        className={classNames(
          'rounded-full bg-Astro-elements-background-depth-3 dark:bg-Astro-elements-background-depth-4 flex items-center justify-center',
      ...
      {description && (
        <p
          className={classNames(
            'text-Astro-elements-textTertiary dark:text-Astro-elements-textTertiary-dark text-center max-w-xs',
            styles.description,
          )}
        >
          {description}
