      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-Astro-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-Astro-elements-item-backgroundAccent hover:bg-Astro-elements-artifacts-backgroundHover"
