  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-Astro-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-Astro-elements-background-depth-2 border-y border-Astro-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-Astro-elements-terminals-buttonBackground text-Astro-elements-textSecondary hover:text-Astro-elements-textPrimary':
                            isActive,
                          'bg-Astro-elements-background-depth-2 text-Astro-elements-textSecondary hover:bg-Astro-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-Astro-elements-terminals-buttonBackground text-Astro-elements-textPrimary': isActive,
                            'bg-Astro-elements-background-depth-2 text-Astro-elements-textSecondary hover:bg-Astro-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-Astro-elements-textTertiary hover:text-Astro-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachAstroTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting Astro terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachAstroTerminal(terminal)}
