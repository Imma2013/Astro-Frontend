...
import { createFilesContext, extractCurrentContext, extractPropertiesFromMessage, simplifyAstroActions } from './utils';
...
---
  ...
  if (totalFiles == 0) {
    throw new Error(`Astro failed to select files`);
  }
